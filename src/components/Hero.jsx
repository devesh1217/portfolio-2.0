    ...
    <section className="relative min-h-[90vh] flex items-center md:pt-20 pb-16">
      <div className="container mx-auto px-4 grid md:grid-cols-2 gap-12 items-center">
        <div className="order-2 md:order-1">
          <h2 className="font-playfair text-2xl md:text-5xl font-bold mb-6">
            नमस्ते & Hello, I'm
          </h2>
          <h1 className="font-playfair text-3xl md:text-6xl font-bold mb-4">
          ...
          <p className="text-md md:text-xl text-gray-700 dark:text-gray-200 mb-8 max-w-md backdrop-blur-sm">
